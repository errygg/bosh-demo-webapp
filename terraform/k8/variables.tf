...
variable "license_file" {
  description = "Local location of the license file"
  default     = "~/license.lic"
}
...
variable "peer_datacenter" {
  description = "Peer datacenter to create a Network Area connection with"
  default     = "dc1"
}

# Required
variable "peer_datacenter_address" {
  description = "Peer datacenter address to use for the Network Area connection"
}
